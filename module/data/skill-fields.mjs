...
export const SKILL_FIELDS = {
  ...
  'Communications': f('civilian', ['Acting', 'Career/Communications', 'Comms/Conventional', 'Computers', 'Protocol/Any', 'Sensor Operations'], { attrs: { int: 4 } }),
  ...
  'HPG Technician': f('civilian', ['Administration', 'Comms/Conventional', 'Comms/HPG', 'Computers', 'Cryptography'], { fields: ['Communications'], note: 'ComStar, Word of Blake or Clan affiliation only.' }),
  ...
  'Pilot – Aerospace (Civilian)': f('civilian', ['Career/Aerospace Pilot', 'Comms/Conventional', 'Navigation/Air', 'Navigation/Space', 'Piloting/Aerospace', 'Sensor Operations'], { attrs: { dex: 3, rfl: 4, int: 3 } }),
  'Pilot – Aircraft (Civilian)': f('civilian', ['Career/Aircraft Pilot', 'Comms/Conventional', 'Navigation/Air', 'Piloting/Air Vehicle or VTOL', 'Sensor Operations'], { attrs: { dex: 3, rfl: 3 } }),
  'Pilot – DropShip': f('civilian', ['Career/DropShip Pilot', 'Comms/Conventional', 'Navigation/Space', 'Piloting/Spacecraft', 'Sensor Operations', 'Zero-G Operations'], { attrs: { dex: 4, int: 3, wil: 3 }, forbidTraits: ['TDS'] }),
  ...
  "Technician – 'Mech": f('civilian', ['Technician/Electronic', 'Technician/Jet', 'Technician/Mechanical', 'Technician/Myomer', 'Technician/Nuclear'], { fields: ['Technician – Civilian', 'Technician – Military'], attrs: { int: 4 } }),
  ...
  'Intelligence': f('intelligence', ['Comms/Conventional', 'Computers', 'Cryptography', 'Language/Any', 'Sensor Operations'], { attrs: { int: 4, wil: 4 }, note: 'Or INT 3, WIL 4 with the Police Officer Field.' }),
  ...
  'Infantry': f('military', ['Acrobatics/Free-Fall', 'Artillery', 'Climbing', 'Comms/Conventional', 'Support Weapons', 'Tactics/Infantry'], { fields: ['Basic Training'] }),
  ...
  'Scout': f('military', ['Comms/Conventional', 'Disguise', 'Language/Any', 'Security Systems/Any', 'Stealth', 'Streetwise/Any', 'Tracking/Any'], { fields: ['Basic Training'], attrs: { int: 4, wil: 3 }, forbidTraits: ['Illiterate'] }),
  ...
  'Technician – Military': f('military', ['Appraisal', 'Career/Technician', 'Technician/Electronics', 'Technician/Mechanical', 'Technician/Nuclear', 'Technician/Weapons'], { attrs: { int: 3, dex: 3 } })
};
